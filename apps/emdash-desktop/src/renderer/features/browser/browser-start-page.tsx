            ...
            <div className="flex flex-col gap-2">
              {localUrls.map((url) => (
                <button
                  key={url}
                  type="button"
                  className="group flex min-h-16 w-full items-center gap-3 rounded-lg border border-border bg-background px-4 py-3 text-left transition-colors hover:border-border hover:bg-background-secondary focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-none"
